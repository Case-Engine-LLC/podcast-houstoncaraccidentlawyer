...
export const chapters = [
  ...
  {
    "number": 2,
    "title": "Understanding Texas Negligence Laws",
    "active": false
  },
  {
    "number": 3,
...
export const faqGroups = [
  ...
  },
  {
    ...
    "description": "Common legal questions answered by Ben Dominguez about personal injury cases in Houston",
    "questions": [
      {
...
export const topicalEntryGrid = {
  "title": "Explore Legal Topics by Practice Area",
  "tabs": [
    {
      "label": "Car Accidents",
      "links": [
...
export const formConfig = {
  ...
  notifyEmails: process.env.NEXT_PUBLIC_FORM_NOTIFY_EMAILS || "contact@benwins.com",
  fields: [
