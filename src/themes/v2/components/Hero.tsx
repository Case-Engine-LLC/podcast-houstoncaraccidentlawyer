        ...
        <div className="relative h-[500px] lg:h-[600px] w-full">
          ...
          <div className="absolute -bottom-12 -left-6 lg:left-12 bg-white p-6 rounded-2xl shadow-xl max-w-sm w-[90%] border-l-4 border-secondary">
            ...
            <div className="flex items-center gap-4">
              <Link href={`/v2/episode/${episode.number}`} className="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center hover:bg-secondary transition-colors shadow-lg">
