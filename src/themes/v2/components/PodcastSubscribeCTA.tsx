  ...
  return (
    <section id="subscribe" className="py-24 bg-primary text-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        {/* Email Form */}
        {submitted ? (
          <div className="max-w-lg mx-auto bg-white/5 border border-white/20 rounded-lg p-6 text-center">
            <p className="text-white font-bold mb-4">Thanks — you&rsquo;re subscribed.</p>
            <p className="text-white/60 text-sm mb-4">Listen to new episodes the moment they drop:</p>
            <div className="flex justify-center gap-3">
              <a
                href={siteConfig.platformLinks.spotify}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-secondary text-white font-bold px-6 py-2.5 rounded-lg hover:bg-secondary-hover transition-colors"
              >
                Spotify
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white text-primary font-bold px-6 py-2.5 rounded-lg hover:bg-white/90 transition-colors"
              >
                Apple Podcasts
              </a>
            </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 max-w-lg mx-auto">
            ...
            <button
              type="submit"
              className="bg-secondary text-white font-bold px-8 py-4 rounded-lg hover:bg-secondary-hover transition-colors"
            >
              Subscribe
            </button>
          </form>
