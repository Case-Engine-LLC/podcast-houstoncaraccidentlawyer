    ...
    <footer className="bg-primary text-white pt-16 md:pt-24 pb-12 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8 md:gap-12 mb-12 md:mb-16">
        ...
        <div className="md:col-span-1">
          <div className="mb-6">
            <img src="/images/logo.svg" alt="Logo" className="h-24 md:h-28 w-auto object-contain" />
          </div>
          ...
          <div className="flex gap-4">
            <a href={siteConfig.platformLinks.spotify} className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-secondary transition-colors">
            ...
            <a href={siteConfig.platformLinks.apple} className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-secondary transition-colors">
        ...
        {/* Navigation */}
        <div>
          <h3 className="font-heading text-lg font-bold mb-6 text-secondary">Navigation</h3>
          <ul className="space-y-3 text-sm text-gray-400">
